...
_MODULE_NAME = "pysysml"
_PACKAGE_NAME = 'pysysml'
...
setup(
    ...
    package_data={
        package_name: ['*.yaml', '*.yml', '*.json', '*.txt', '*.lark', '*.sha256']
    ...
    url='https://github.com/HansBug/pysysml',
    ...
    entry_points={
        'console_scripts': [
            'pysysml=pysysml.entry:pysysmlcli'
        ]
    },
)
